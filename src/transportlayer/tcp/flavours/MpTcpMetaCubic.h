...
#ifndef INET_TRANSPORTLAYER_TCP_FLAVOURS_MPTCPMETACUBIC_H_
#define INET_TRANSPORTLAYER_TCP_FLAVOURS_MPTCPMETACUBIC_H_
...
class INET_API MpTcpMetaCubic: public MpTcpCubicBase {
protected:
    MpTcpCubicStateVariables *&state; // alias to TcpAlgorithm's 'state'
