...
Register_Class(MpTcpSubflowCubic);

simsignal_t MpTcpSubflowCubic::bicTargetSignal = cComponent::registerSignal("bicTarget");
simsignal_t MpTcpSubflowCubic::originPointSignal = cComponent::registerSignal("originalPoint");
simsignal_t MpTcpSubflowCubic::cwndSegSignal = cComponent::registerSignal("cwndSeg");
simsignal_t MpTcpSubflowCubic::bicKSignal = cComponent::registerSignal("bicK");
simsignal_t MpTcpSubflowCubic::cntSignal = cComponent::registerSignal("cnt");
simsignal_t MpTcpSubflowCubic::lastMaxWindowSignal = cComponent::registerSignal("lastMaxWindow");
simsignal_t MpTcpSubflowCubic::delayMinSignal = cComponent::registerSignal("delayMin");
simsignal_t MpTcpSubflowCubic::concaveSignal = cComponent::registerSignal("concave");
simsignal_t MpTcpSubflowCubic::convexSignal = cComponent::registerSignal("convex");
simsignal_t MpTcpSubflowCubic::friendlySignal = cComponent::registerSignal("friendly");

simsignal_t MpTcpSubflowCubic::sndUnaSignal = cComponent::registerSignal("sndUna");
simsignal_t MpTcpSubflowCubic::recoveryPointSignal = cComponent::registerSignal("recoveryPoint");

MpTcpSubflowCubic::MpTcpSubflowCubic() :
        MpTcpCubicBase(), state(
                (MpTcpCubicStateVariables*&) TcpAlgorithm::state) {
}

void MpTcpSubflowCubic::reset() {
    state->cnt = 0;
...
void MpTcpSubflowCubic::established(bool active)
{
...
uint64_t MpTcpSubflowCubic::__fls(uint64_t word)
{
...
int MpTcpSubflowCubic::fls64(uint64_t x)
{
    if (x == 0)
        return 0;
    return __fls(x) + 1;
...
uint32_t MpTcpSubflowCubic::calculateCubicRoot(uint64_t a) {
    uint32_t x, b, shift;
        /*
...
void MpTcpSubflowCubic::updateCubicCwnd(uint32_t acked) {
...
void MpTcpSubflowCubic::recalculateSlowStartThreshold() {
